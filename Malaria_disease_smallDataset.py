...
folders = glob('Dataset_small/train/*')
folders
...
# Use the Image Data Generator to import the images from the Dataset_small
...
val_set = val_datagen.flow_from_directory(val_path, target_size=(
...
model_version = max([int(i) for i in os.listdir(
    "saved_models") if i != '.DS_Store'] + [0])+1
model_version
